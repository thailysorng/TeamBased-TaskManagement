                ...
                <div className="w-full grid grid-cols-2 gap-4">
                  {task?.assets?.map((el, index) => (
                    <img
                      ...
                      src={el}
                      alt={task?.title}
                      className="w-full rounded h-28 md:h-36 2xl:h-25 curosr-pointer transition-all duration-700 hover:scale-125 hover:z-50"
                    />
                  ))}
                </div>
              </div>
...
const Activities = ({ activity, id, refetch }) => {
  ...
  const [postActivity, {isLoading}]  = usePostTaskActivityMutation(id);
